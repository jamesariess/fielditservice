...
<div id="new-ticket-modal" class="modal-overlay" style="display:none;">
    <div class="backdrop" onclick="closeModal('new-ticket-modal')" style="background:rgba(0,0,0,0.6);backdrop-filter:blur(6px);"></div>
    <div class="modal-panel" style="position:fixed;top:50%;left:50%;transform:translate(-50%,-50%);max-width:560px;background:#fff;border-radius:16px;z-index:10001;box-shadow:0 25px 60px rgba(0,0,0,0.3);max-height:90vh;overflow-y:auto;">
